...
export default function LoginModal({ isOpen, onClose }) {
   const { loggedIn, loading, userInfo, login, logout, getAccounts, getBalance } = useWeb3Auth();
            ...
            <div className="space-y-4">
               {userInfo && (
                  <div className="bg-gray-800 p-4 rounded-lg">
                     ...
                     <p className="text-gray-300 text-sm">Email: {userInfo.email || 'N/A'}</p>
                     <p className="text-gray-300 text-sm">Name: {userInfo.name || 'N/A'}</p>
                  </div>
               )}
      ...
      <Modal isOpen={isOpen} onClose={onClose} title="Login to Meno">
         <div className="space-y-4">
            ...
            <div className="space-y-3">
               ...
               {/* Keep the original wallet buttons as fallback/decoration */}
